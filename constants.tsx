...
import { UserRole, TicketStatus, TicketPriority, ProductCategory, AuditLogAction } from './types';
import { 
    LayoutDashboard, 
    Ticket, 
    Users, 
...
export const AUDIT_ACTION_COLORS: Record<AuditLogAction, string> = {
  ...
  // constants.ts
  [AuditLogAction.USER_CREATED]: 'bg-blue-100 text-blue-800',
  [AuditLogAction.USER_UPDATED]: 'bg-yellow-100 text-yellow-800',
  [AuditLogAction.USER_DELETED]: 'bg-red-100 text-red-800',
  [AuditLogAction.TICKET_CREATED]: 'bg-green-100 text-green-800',
  [AuditLogAction.TICKET_UPDATED]: 'bg-yellow-100 text-yellow-800',
  [AuditLogAction.TICKET_DELETED]: 'bg-red-100 text-red-800',
  [AuditLogAction.TICKET_ASSIGNED]: 'bg-purple-100 text-purple-800',
  [AuditLogAction.TICKET_RESOLVED]: 'bg-green-100 text-green-800',
  [AuditLogAction.TICKET_REOPENED]: 'bg-orange-100 text-orange-800',
  [AuditLogAction.PAYMENT_PROCESSED]: 'bg-green-100 text-green-800',
  [AuditLogAction.PAYMENT_FAILED]: 'bg-red-100 text-red-800',
  [AuditLogAction.SETTINGS_UPDATED]: 'bg-blue-100 text-blue-800',
  [AuditLogAction.REPORT_GENERATED]: 'bg-indigo-100 text-indigo-800',
  [AuditLogAction.DATA_EXPORTED]: 'bg-purple-100 text-purple-800',
  [AuditLogAction.PASSWORD_CHANGED]: 'bg-teal-100 text-teal-800',
  [AuditLogAction.PROFILE_UPDATED]: 'bg-cyan-100 text-cyan-800'
};